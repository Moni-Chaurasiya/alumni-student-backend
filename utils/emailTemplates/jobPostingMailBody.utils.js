...
<body>
    <div class="email-container">
        ...
        <div class="job-section">
            <p>Dear Student,</p>
            <p>We're excited to share a new job opportunity posted by one of our alumni:</p>
            ...
            <a href="${process.env.FRONTEND_URL}/jobs/${jobId}" class="action-button">View Job Details & Apply</a>
            
            <p>Don't miss this opportunity! Review the job posting and submit your application if interested.</p>
...
module.exports=jobPostingMailBody;