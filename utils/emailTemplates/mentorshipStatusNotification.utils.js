function mentorshipStatusNotification(studentName, alumniName, status) {
    ...
    const messageText = status === 'accepted' 
        ? `Great news! ${alumniName} has accepted your mentorship request. You can now start your mentorship journey together.`
        : `We're sorry to inform you that ${alumniName} has declined your mentorship request at this time. This could be due to their current commitments or availability.`;
...
<body>
    <div class="email-container">
        <div class="header">
            <h1>INGENIA</h1>
            <h2>Mentorship Status Update</h2>
        </div>
        
        <div class="status-section">
            <p>Dear ${studentName},</p>
            <p>${messageText}</p>
            <div class="status-badge">Request ${statusText}</div>
            
            ${status === 'accepted' ? `
            <div class="next-steps">
                <h3>Next Steps:</h3>
                <p>1. Login to your account to view the mentorship details</p>
                <p>2. Schedule your first meeting with your mentor</p>
                <p>3. Prepare questions and topics you'd like to discuss</p>
            </div>
            ` : `
            <div class="next-steps">
                <h3>What You Can Do Next:</h3>
                <p>1. Explore other potential mentors on our platform</p>
                <p>2. Update your profile to highlight your specific interests and goals</p>
                <p>3. Reach out to faculty advisors for additional guidance</p>
            </div>
            `}
            
            <p>Thank you for using our mentorship platform. We're here to support your professional development journey.</p>
        </div>
...
module.exports = mentorshipStatusNotification;